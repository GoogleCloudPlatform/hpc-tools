...
# For EL9, if building on rocky linux, override dist to be el9.
%if 0%{?rhel} == 9
  %define dist .el9
%endif
...
install -p -m 0755 google_disable_automatic_updates %{buildroot}%{_bindir}/google_disable_automatic_updates
...
%{_bindir}/google_disable_automatic_updates
